...
class column marks as new or REAL-chronic, within your three-call budget. When
an alert identifies a pod, inspect its status before retrieving the affected
